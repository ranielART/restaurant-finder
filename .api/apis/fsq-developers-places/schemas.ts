            ...
            properties: {
                      ...
                      photo: {
                        ...
                        properties: {
                          ...
                          classifications: {
                            type: "array",
                            properties: {
                              traversable_again: { type: "boolean" },
                            },
                            items: { type: "string" },
                          },
                          tip: {
              ...
              place: {
                ...
                properties: {
                  ...
                  latitude: { type: "object", additionalProperties: true },
                  longitude: { type: "object", additionalProperties: true },
                  categories: {
                    type: "array",
                    properties: { traversable_again: { type: "boolean" } },
                    items: {
                  ...
                  attributes: {
                    type: "object",
                    properties: {
                      restroom: { type: "object", additionalProperties: true },
                      outdoor_seating: {
                        type: "object",
                        additionalProperties: true,
                      },
                      atm: { type: "object", additionalProperties: true },
                      has_parking: {
                        type: "object",
                        additionalProperties: true,
                      },
            ...
            properties: {
              ...
              attributes: {
                ...
                properties: {
                  ...
                  atm: { type: "object", additionalProperties: true },
                  has_parking: { type: "object", additionalProperties: true },
                  wifi: { type: "string" },
                  delivery: { type: "object", additionalProperties: true },
    ...
    "200": {
      ...
      properties: {
        ...
        attributes: {
          ...
          properties: {
            restroom: { type: "object", additionalProperties: true },
            outdoor_seating: { type: "object", additionalProperties: true },
            atm: { type: "object", additionalProperties: true },
            has_parking: { type: "object", additionalProperties: true },
            wifi: { type: "string" },
            delivery: { type: "object", additionalProperties: true },
            reservations: { type: "object", additionalProperties: true },
            takes_credit_card: { type: "object", additionalProperties: true },
          },
        },
        hours: {
          type: "object",
      ...
      },
      {
        ...
        properties: {
          ...
          fields: {
            ...
            $schema: "http://json-schema.org/draft-04/schema#",
            description:
              "List of fields being flagged as incorrect. Possible values are:<ul><li>address</li><li>latitude</li><li>longitude</li><li>locality</li><li>name</li><li>tel</li><li>postcode</li><li>region</li><li>state</li><li>website</li></ul>",
          },
          comment: {
            type: "string",
            $schema: "http://json-schema.org/draft-04/schema#",
    ...
    allOf: [
      {
        ...
        properties: {
          ...
          ne: {
            ...
            $schema: "http://json-schema.org/draft-04/schema#",
            description:
              "The north-east corner of the bounding box to search within",
          },
          sw: {
            type: "string",
            $schema: "http://json-schema.org/draft-04/schema#",
            description:
              "The south-west corner of the bounding box to search within",
          },
        },
        required: [],
      },
